export default function HomeDepot() {
  const deals = [
    {emoji:'🪚', badge:'-74%', name:'RYOBI 18V Circular Saw Kit', price:'$39', orig:'$149', save:'$110', stock:'In stock nearby', stockColor:'#2a7a3b'},
    {emoji:'🚿', badge:'-82%', name:'Kohler Rain Shower Head', price:'$24', orig:'$134', save:'$110', stock:'Only 3 left', stockColor:'#e67e00'},
    {emoji:'💡', badge:'-75%', name:'EcoSmart 65W LED 6-pack', price:'$11', orig:'$44', save:'$33', stock:'In stock nearby', stockColor:'#2a7a3b'},
    {emoji:'🪣', badge:'-69%', name:'Behr Marquee Interior Paint 1gal', price:'$18', orig:'$59', save:'$41', stock:'Last 1', stockColor:'#dc2626'},
    {emoji:'🔨', badge:'-60%', name:'Husky 100pc Mechanics Tool Set', price:'$59', orig:'$149', save:'$90', stock:'In stock nearby', stockColor:'#2a7a3b'},
    {emoji:'🌿', badge:'-50%', name:'Vigoro Premium Mulch 2cuft', price:'$2', orig:'$4', save:'$2', stock:'In stock nearby', stockColor:'#2a7a3b'},
  ];
  return (
    <div style={{fontFamily:'sans-serif', background:'#F7F5F0', minHeight:'100vh'}}>
      ...
      <div style={{background:'#F96302', padding:'2rem 2rem 2.5rem'}}>
        ...
        <h1 style={{fontSize:'32px', fontWeight:800, color:'#fff', margin:'0 0 0.5rem', letterSpacing:'-1px'}}>Home Depot Clearance</h1>
        ...
        <div style={{display:'flex', gap:'1rem'}}>
          <a href="/locator" style={{background:'#fff', color:'#F96302', borderRadius:'8px', padding:'9px 18px', fontSize:'13px', fontWeight:600, textDecoration:'none'}}>📍 Find near me</a>
          <div style={{background:'rgba(255,255,255,0.15)', color:'#fff', borderRadius:'8px', padding:'9px 18px', fontSize:'13px', fontWeight:500}}>47 items in stock locally</div>
        </div>
      </div>
      <div style={{background:'#fff', borderBottom:'1px solid #e8e4dc', padding:'0.75rem 2rem', display:'flex', gap:'8px', overflowX:'auto'}}>
        {['All','Tools','Paint','Lighting','Plumbing','Garden'].map((cat,i) => (
