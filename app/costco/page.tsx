export default function Costco() {
  const deals = [
    {emoji:'🌀', badge:'-70%', name:'Dyson V8 Cordless Vacuum', price:'$139', orig:'$469', save:'$330', stock:'In stock nearby', stockColor:'#2a7a3b'},
    {emoji:'🛋️', badge:'-55%', name:'Thomasville Leather Sofa', price:'$599', orig:'$1299', save:'$700', stock:'Only 2 left', stockColor:'#e67e00'},
    {emoji:'🖥️', badge:'-45%', name:'LG 27" 4K UHD Monitor', price:'$219', orig:'$399', save:'$180', stock:'In stock nearby', stockColor:'#2a7a3b'},
    {emoji:'🧴', badge:'-60%', name:'Kirkland Shampoo 25oz 2-pack', price:'$8', orig:'$19', save:'$11', stock:'In stock nearby', stockColor:'#2a7a3b'},
    {emoji:'🏕️', badge:'-50%', name:'Coleman 6-Person Tent', price:'$79', orig:'$159', save:'$80', stock:'Last 4', stockColor:'#e67e00'},
    {emoji:'⌚', badge:'-65%', name:'Garmin Forerunner 55 GPS Watch', price:'$99', orig:'$279', save:'$180', stock:'In stock nearby', stockColor:'#2a7a3b'},
  ];
  return (
    <div style={{fontFamily:'sans-serif', background:'#F7F5F0', minHeight:'100vh'}}>
      ...
      <div style={{background:'#E31837', padding:'2rem 2rem 2.5rem'}}>
        ...
        <h1 style={{fontSize:'32px', fontWeight:800, color:'#fff', margin:'0 0 0.5rem', letterSpacing:'-1px'}}>Costco Clearance</h1>
        ...
        <div style={{display:'flex', gap:'1rem'}}>
          <a href="/locator" style={{background:'#fff', color:'#E31837', borderRadius:'8px', padding:'9px 18px', fontSize:'13px', fontWeight:600, textDecoration:'none'}}>📍 Find near me</a>
          <div style={{background:'rgba(255,255,255,0.15)', color:'#fff', borderRadius:'8px', padding:'9px 18px', fontSize:'13px', fontWeight:500}}>12 items in stock locally</div>
        </div>
      </div>
      <div style={{background:'#fff', borderBottom:'1px solid #e8e4dc', padding:'0.75rem 2rem', display:'flex', gap:'8px', overflowX:'auto'}}>
        {['All','Electronics','Furniture','Outdoors','Health','Appliances'].map((cat,i) => (
